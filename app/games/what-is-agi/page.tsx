...
export default function WhatIsAgiPage() {
  ...
  if (phase === 'done') return <GameComplete slug="what-is-agi" />

  if (phase === 'intro') return (
    <GameIntro
      title={isPT ? 'O Que É a IAG' : 'What Is AGI'}
      type="group"
      description={
        isPT
          ? 'A IAG está chegando — mas o que isso significa de verdade? Agrupe estas 16 cartas sobre capacidades e limites da IA.'
          : 'AGI is coming — but what does that actually mean? Group these 16 cards about AI capabilities and limits.'
      }
      howToPlay={isPT ? [
