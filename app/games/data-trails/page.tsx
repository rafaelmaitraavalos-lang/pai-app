...
import puzzlePT from '../../data/puzzles/data-trails_pt'
...
export default function DataTrailsPage() {
  ...
  if (phase === 'done') return <GameComplete slug="data-trails" />

  if (phase === 'intro') return (
    <GameIntro
      title={isPT ? 'Rastros de Dados' : 'Data Trails'}
      type="group"
      description={
        isPT
          ? 'Você deixa rastros de dados por toda parte. Agrupe estas 16 cartas em 4 categorias de dados, privacidade e IA.'
          : 'You leave data trails everywhere. Group these 16 cards into 4 categories of data, privacy, and AI.'
      }
      howToPlay={isPT ? [
