...
const wm_w1_pt: Record<number, LessonData> = {
  311: {
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `A IA consegue superar os humanos em certas tarefas específicas porque processou muito mais exemplos do que qualquer humano conseguiria durante toda a vida.`, answer: true, verdict: "Correto.", explanation: "A resposta é VERDADEIRO. Por que a IA consegue superar os humanos em certas tarefas específicas? — Ela processou muito mais exemplos do que qualquer humano conseguiria durante toda a vida" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Um filtro de e-mails de spam é um exemplo de IA.`, answer: true, verdict: "Correto.", explanation: "A resposta é VERDADEIRO. Qual destes é um exemplo de IA? — Um filtro de e-mails de spam" },
    ],
  },
  312: {
    id: 312, worldId: 261,
    ...
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Machine learning é um sistema que aprende padrões a partir de exemplos em vez de seguir regras fixas.`, answer: true, verdict: "Correto.", explanation: "A resposta é VERDADEIRO. O que é machine learning? — Um sistema que aprende padrões a partir de exemplos em vez de regras fixas" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Quando um sistema de machine learning faz uma previsão errada, ele se ajusta levemente para reduzir o erro.`, answer: true, verdict: "Correto.", explanation: "A resposta é VERDADEIRO. No ciclo de aprendizado do machine learning, o que acontece depois que o sistema faz uma previsão errada? — Ele se ajusta levemente para reduzir o erro" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Repetir o ciclo de treinamento bilhões de vezes é importante porque pequenos ajustes se acumulam em melhorias reais e significativas.`, answer: true, verdict: "Correto.", explanation: "A resposta é VERDADEIRO. Por que repetir o ciclo de treinamento bilhões de vezes é importante? — Pequenos ajustes se acumulam em melhorias reais e significativas" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `O machine learning só pode ser aplicado a um único tipo de tarefa, como reconhecimento de imagens.`, answer: false, verdict: "Correto.", explanation: "A resposta é FALSO. A quais tarefas o machine learning pode ser aplicado? — A uma ampla variedade de tarefas, incluindo detecção de spam, recomendação de músicas e imagens médicas" },
    ],
  },
  313: {
    id: 313, worldId: 261,
    ...
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `O artigo de Alan Turing de 1950 começava com a pergunta "As máquinas podem pensar?"`, answer: true, verdict: "Correto.", explanation: "A resposta é VERDADEIRO. Com que pergunta o artigo de Alan Turing de 1950 começava? — As máquinas podem pensar?" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `No Teste de Turing, um juiz tenta determinar se está conversando com um humano ou uma máquina.`, answer: true, verdict: "Correto.", explanation: "A resposta é VERDADEIRO. O que é o Teste de Turing? — Um teste em que um juiz tenta determinar se está conversando com um humano ou uma máquina" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Turing mudou o foco de se as máquinas realmente pensam para se o comportamento delas é indistinguível do pensamento.`, answer: true, verdict: "Correto.", explanation: "A resposta é VERDADEIRO. Como Turing reformulou a questão da inteligência das máquinas? — Ele mudou o foco de se as máquinas realmente pensam para se o comportamento delas é indistinguível do pensamento" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Uma máquina que passa no Teste de Turing é definitivamente inteligente da mesma forma que um humano.`, answer: false, verdict: "Correto.", explanation: "A resposta é FALSO. Qual é a principal crítica ao Teste de Turing? — Comportar-se de forma inteligente não é o mesmo que ser realmente inteligente" },
    ],
  },
  314: {
    id: 314, worldId: 261,
  ...
  318: {
    ...
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `O único tipo de IA que existe atualmente é a IA Estreita.`, answer: true, verdict: "Correto.", explanation: "A resposta é VERDADEIRO. Que tipo de IA existe atualmente? — IA Estreita" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `A IAG é uma IA hipotética capaz de realizar qualquer tarefa cognitiva que um humano possa.`, answer: true, verdict: "Correto.", explanation: "A resposta é VERDADEIRO. O que é IAG? — Uma IA hipotética capaz de realizar qualquer tarefa cognitiva que um humano possa" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `A maioria dos medos públicos sobre IA — como deslocamento de empregos e risco existencial — se relaciona à IAG, não aos sistemas de IA estreita que existem hoje.`, answer: true, verdict: "Correto.", explanation: "A resposta é VERDADEIRO. Por que a distinção entre IA estreita e IAG importa para o debate público? — A maioria dos medos públicos se relaciona à IAG, não aos sistemas de IA estreita que existem hoje" },
