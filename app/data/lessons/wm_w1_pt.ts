...
const wm_w1_pt: Record<number, LessonData> = {
  311: {
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Todos os sistemas de IA funcionam da mesma maneira.`, answer: false, verdict: "Correto.", explanation: "Diferentes sistemas de IA são construídos para propósitos diferentes — um chatbot, um sistema de reconhecimento facial e um algoritmo de recomendação são todos IA, mas não funcionam da mesma forma." },
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Um filtro de e-mails de spam é um exemplo de IA.`, answer: true, verdict: "Correto.", explanation: "Qual destes é um exemplo de IA? — Um filtro de e-mails de spam" },
    ],
  },
  312: {
    id: 312, worldId: 261,
    ...
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Machine learning é um sistema que aprende padrões a partir de exemplos em vez de seguir regras fixas.`, answer: true, verdict: "Correto.", explanation: "O que é machine learning? — Um sistema que aprende padrões a partir de exemplos em vez de regras fixas" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Quando um sistema de machine learning faz uma previsão errada, ele se ajusta levemente para reduzir o erro.`, answer: true, verdict: "Correto.", explanation: "No ciclo de aprendizado do machine learning, o que acontece depois que o sistema faz uma previsão errada? — Ele se ajusta levemente para reduzir o erro" },
  ...
  313: {
    ...
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `O artigo de Alan Turing de 1950 começava com a pergunta "As máquinas podem pensar?"`, answer: true, verdict: "Correto.", explanation: "Com que pergunta o artigo de Alan Turing de 1950 começava? — As máquinas podem pensar?" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `No Teste de Turing, um juiz tenta determinar se está conversando com um humano ou uma máquina.`, answer: true, verdict: "Correto.", explanation: "O que é o Teste de Turing? — Um teste em que um juiz tenta determinar se está conversando com um humano ou uma máquina" },
  ...
  314: {
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Os sistemas de IA têm seus próprios objetivos e motivações.`, answer: false, verdict: "Correto.", explanation: "Verdadeiro ou falso: Os sistemas de IA têm seus próprios objetivos e motivações. — Falso — qualquer objetivo aparente vem de como o sistema foi projetado" },
  ...
  316: {
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Os sistemas especialistas eram programas que codificavam a expertise humana como regras explícitas.`, answer: true, verdict: "Correto.", explanation: "O que eram sistemas especialistas? — Programas que codificavam a expertise humana como regras explícitas" },
  ...
  318: {
    ...
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `O único tipo de IA que existe atualmente é a IA Estreita.`, answer: true, verdict: "Correto.", explanation: "Que tipo de IA existe atualmente? — IA Estreita" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `A IAG é uma IA hipotética capaz de realizar qualquer tarefa cognitiva que um humano possa.`, answer: true, verdict: "Correto.", explanation: "O que é IAG? — Uma IA hipotética capaz de realizar qualquer tarefa cognitiva que um humano possa" },
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `A IA superinteligente existe atualmente e está sendo usada por governos.`, answer: false, verdict: "Correto.", explanation: "Verdadeiro ou falso: A IA superinteligente existe atualmente. — Falso" },
    ],
  },
}
