...
const wm_w1_pt: Record<number, LessonData> = {
  ...
  312: {
    ...
    stops: [
      ...
      { tag: "Big idea", title: "Prever, Medir, Ajustar", body: "O sistema melhora ao ver exemplos, fazer previsões, medir seus erros e se ajustar. Esse processo pode ser repetido milhões ou bilhões de vezes." },
      { tag: "Hot take", title: "Pequenos Passos, Grandes Ganhos", body: "Nenhum ajuste individual muda muita coisa. A melhoria vem da repetição ao longo de um número enorme de exemplos." },
    ],
    questions: [
  ...
  313: {
    ...
    stops: [
      ...
      { tag: "Example", title: "O Teste da Imitação", body: "Turing não tentou resolver a questão diretamente. Em vez disso, ele propôs um teste. Imagine um juiz humano tendo duas conversas por texto ao mesmo tempo — uma com uma pessoa, outra com uma máquina. Se o juiz não conseguir distinguir de forma confiável quem é quem, a máquina passou no que mais tarde ficou conhecido como o Teste de Turing." },
      { tag: "Big idea", title: "Comportamento Acima da Essência", body: "Turing mudou o debate. Em vez de perguntar se uma máquina realmente pensa, ele perguntou se o comportamento dela poderia parecer inteligente visto de fora. Essa reformulação — focada no comportamento observável em vez da experiência interna — ajudou a moldar todo o campo da IA." },
      { tag: "Hot take", title: "Parecer Inteligente Não É Saber", body: "O teste ainda é debatido. Uma máquina pode soar convincente sem entender o que está dizendo. Mas a pergunta de Turing ajudou a moldar o campo da IA e permanece relevante até hoje." },
    ],
    questions: [
  ...
  314: {
    ...
    stops: [
      ...
      { tag: "Big idea", title: "Fluente Sem Compreender", body: "Um modelo de linguagem pode escrever uma redação convincente sem entender uma única palavra dela. Ele gera continuações estatisticamente prováveis de texto com base em padrões nos dados de treinamento — não em significado, intenção ou compreensão." },
  ...
  315: {
    ...
    stops: [
      ...
      { tag: "Hot take", title: "Consciência Dá Controle", body: "Entender isso dá a você mais controle." },
    ],
    questions: [
  ...
  317: {
    ...
    stops: [
      ...
      { tag: "Big idea", title: "Quem Constrói Define Quem Se Beneficia", body: "A concentração do desenvolvimento de IA importa. Os pesquisadores e engenheiros que constroem a IA têm seus próprios valores, pontos cegos e acesso a dados. Um sistema construído principalmente por pessoas de contextos ricos e anglófonos pode ter um desempenho menos confiável para pessoas fora desses contextos." },
      { tag: "Hot take", title: "Vale Perguntar", body: "Isso não significa que a IA seja sempre tendenciosa ou prejudicial. Significa que perguntar quem constrói a IA, por que e com quais dados é uma questão razoável e importante — não uma questão conspiratória." },
    ],
    questions: [
  ...
  318: {
    ...
    stops: [
      ...
      { tag: "Big idea", title: "Superinteligência É Teoria", body: "A IA superinteligente — IA que supera a inteligência humana em todos os domínios — existe apenas na teoria. Alguns pesquisadores a consideram um resultado plausível a longo prazo; outros acham que nunca será alcançada." },
      { tag: "Hot take", title: "Medos Superam a Realidade", body: "A maior parte da preocupação pública com a IA — deslocamento de empregos, decisões autônomas perigosas, risco existencial — se relaciona à IA geral ou superinteligente. Entender o que realmente temos (IA estreita) versus o que é especulativo ajuda a enquadrar esses debates com mais precisão." },
    ],
    questions: [
