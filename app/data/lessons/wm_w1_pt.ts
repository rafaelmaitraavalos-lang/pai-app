...
const wm_w1_pt: Record<number, LessonData> = {
  ...
  314: {
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Quando um modelo de linguagem escreve uma redação convincente, ele está gerando padrões de texto estatisticamente prováveis sem verdadeiro entendimento.`, answer: true, verdict: "Correto.", explanation: "A resposta é VERDADEIRO. Quando um modelo de linguagem escreve uma redação convincente, ele está gerando padrões de texto estatisticamente prováveis — sem entender de verdade o que está dizendo." },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Os sistemas de IA têm seus próprios objetivos e motivações.`, answer: false, verdict: "Correto.", explanation: "A resposta é FALSO. Sistemas de IA não querem nada — não têm objetivos próprios, nem motivações, nem planos secretos. Qualquer objetivo que pareçam ter vem de como foram projetados: eles apenas executam os objetivos que as pessoas dão a eles." },
  ...
  317: {
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Perguntar quem constrói a IA, e por quê, é uma questão conspiratória sem fundamento legítimo.`, answer: false, verdict: "Correto.", explanation: "A resposta é FALSO. Perguntar quem constrói a IA, e por quê, não é teoria da conspiração — é uma pergunta razoável e importante sobre responsabilização e sobre as escolhas de design que afetam todo mundo." },
    ],
  },
  318: {
    id: 318, worldId: 261,
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `A IAG é uma IA hipotética capaz de realizar qualquer tarefa cognitiva que um humano possa.`, answer: true, verdict: "Correto.", explanation: "A resposta é VERDADEIRO. A IAG (inteligência artificial geral) seria uma IA capaz de lidar com qualquer tarefa de pensamento que um humano consegue — não só uma especialidade. Ainda é hipotética: ninguém construiu uma, e ninguém sabe quando, ou se, alguém vai construir." },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `O medo de que a IA 'domine o mundo' se relaciona principalmente à IAG, não aos sistemas de IA estreita que existem hoje.`, answer: true, verdict: "Correto.", explanation: "A resposta é VERDADEIRO. Quando as pessoas temem que a IA 'domine o mundo', geralmente estão imaginando a IAG — que ainda não existe. Misturar isso com a IA estreita de hoje atrapalha qualquer debate sério sobre as duas." },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `A IA superinteligente existe atualmente e está sendo usada por governos.`, answer: false, verdict: "Correto.", explanation: "A resposta é FALSO. Nenhuma IA superinteligente existe — nem em governo nenhum, nem em laboratório secreto. A IA de hoje é estreita: impressionante em tarefas específicas, mas nada parecida com uma mente todo-poderosa." },
    ],
  },
}
