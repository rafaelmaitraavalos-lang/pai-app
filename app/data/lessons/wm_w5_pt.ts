...
const wm_w5_pt: Record<number, LessonData> = {
  ...
  352: {
    ...
    stops: [
      ...
      { tag: "Big idea", title: "Criadores Enfrentam Deslocamento", body: "A ascensão da IA generativa também afeta pessoas que produzem trabalhos criativos profissionalmente. Escritores, designers, músicos, ilustradores e dubladores já estão debatendo questões sobre consentimento, remuneração, direitos autorais e substituição. Esses debates vão se intensificar à medida que a tecnologia melhorar." },
      { tag: "Hot take", title: "Quem Se Beneficia de Quem?", body: "Se a IA pode ou não criar algo impressionante é apenas metade da questão. O resto é: quem se beneficia, o trabalho de quem treinou o sistema e o que acontece com as pessoas cujos meios de vida dependem do trabalho criativo." },
    ],
    questions: [
  ...
  353: {
    ...
    stops: [
      ...
      { tag: "Big idea", title: "Robustez, Corrigibilidade, Supervisão", body: "Conceitos-chave em segurança da IA: • Robustez: o sistema funciona de forma confiável em situações para as quais não foi treinado? • Corrigibilidade: os humanos conseguem corrigir ou substituir o sistema quando necessário? • Supervisão escalável: como os humanos mantêm uma supervisão significativa à medida que a IA se torna mais capaz?" },
      { tag: "Hot take", title: "Segurança vs. Velocidade", body: "Existe uma tensão real: a pesquisa de segurança exige desacelerar para testar e verificar. A pressão competitiva — entre empresas e entre países — empurra em direção a uma implantação mais rápida. Gerenciar essa tensão é um dos desafios centrais do campo." },
    ],
    questions: [
  ...
  356: {
    ...
    stops: [
      ...
      { tag: "Big idea", title: "Efeito Líquido Ainda Incerto", body: "A avaliação honesta é que a IA pode ajudar a enfrentar as mudanças climáticas ao mesmo tempo em que contribui para elas. O efeito líquido depende de como a IA é desenvolvida, de como é alimentada e de onde caem os benefícios de sua aplicação." },
      { tag: "Hot take", title: "Custos e Benefícios Não São Compartilhados", body: "Este é um debate ativo e não resolvido. Se os custos de energia da IA valem suas possíveis contribuições para as soluções climáticas depende parcialmente de questões empíricas sobre o impacto e parcialmente de julgamentos de valor sobre quem se beneficia e quem arca com os custos." },
    ],
    questions: [
  ...
  357: {
    ...
    stops: [
      ...
      { tag: "Big idea", title: "Amplie, Não Substitua", body: "Usar a IA bem também significa manter o controle. O melhor uso da IA amplia o seu próprio pensamento — ajuda você a ir mais longe e mais rápido enquanto constrói sua própria compreensão. O pior uso substitui o seu pensamento, deixando você dependente de uma ferramenta sem as habilidades subjacentes." },
      { tag: "Hot take", title: "Perguntas Que Vale Fazer", body: "Perguntas críticas que vale a pena fazer sobre qualquer sistema de IA: • Quem construiu isso, e quais são seus incentivos? • Com quais dados foi treinado, e que vieses isso pode introduzir? • Para que está otimizando? • Quem se beneficia quando funciona — e quem arca com o custo quando falha?" },
    ],
    questions: [
  ...
  358: {
    ...
    stops: [
      { tag: "Fact", title: "O Que Sabemos Agora", body: "O que sabemos: A IA já está profundamente integrada à vida cotidiana e está melhorando rapidamente. Ela levanta questões éticas, sociais e políticas genuínas que não têm respostas técnicas simples." },
      { tag: "Example", title: "O Que Ainda É Desconhecido", body: "O que não sabemos: se e quando a IAG vai surgir; se os problemas de alinhamento podem ser resolvidos antes que os sistemas se tornem significativamente mais poderosos; como a IA vai reformular o emprego a longo prazo; como as nações vão gerenciar a competição em IA; se os benefícios da IA serão distribuídos amplamente ou concentrados." },
      { tag: "Big idea", title: "Todos Têm Voz Nisso", body: "Quem pode ajudar a responder essas perguntas? Pesquisadores, engenheiros, formuladores de políticas, eticistas, educadores, jornalistas, ativistas, eleitores — e as pessoas que estão estudando essas questões agora. Os problemas de IA mais importantes não são puramente técnicos. São sobre justiça, poder, confiança, responsabilização e que tipo de futuro estamos coletivamente dispostos a construir." },
      { tag: "Hot take", title: "Entender É Poder", body: "Quanto mais você entender sobre como a IA funciona, o que ela não consegue fazer e quais interesses a moldam, mais bem posicionado você estará para se engajar com essas questões — como usuário, cidadão e potencialmente como alguém que constrói ou governa esses sistemas." },
    ],
    questions: [
