...
const wm_w2: Record<number, LessonData> = {
  221: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "Many modern AI systems use a structure called a neural network. The name comes from an early comparison to the brain. The human brain contains billions of neurons connected to one another. Those connections change as people learn. Artificial neural networks borrow a very simplified version of that idea. They are not miniature brains. They are mathematical systems made of connected units, often called nodes." },
      { tag: "Example", title: "Slide 2", body: "A basic neural network has three parts: • Input layer: receives information, such as pixels, words, or numbers • Hidden layers: process and transform that information • Output layer: produces a result, such as a prediction or classification" },
      { tag: "Big idea", title: "Slide 3", body: "The connections between nodes have values called weights. A weight determines how strongly one piece of information influences another. Training a neural network means adjusting those weights until the system becomes better at its task." },
      { tag: "Hot take", title: "Slide 4", body: "At the beginning of training, a neural network is not very useful. Its predictions may be wildly inaccurate. The improvement comes entirely from the repeated adjustment of weights across enormous numbers of examples." },
    ],
    questions: [
  ...
  222: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "At the beginning of training, a neural network is not very useful. Its predictions may be wildly inaccurate. Training helps the network improve through a structured process." },
      { tag: "Example", title: "Slide 2", body: "The training process: 1. The network makes a prediction. 2. The prediction is compared with the correct answer. 3. The system measures how far off it was. This difference is called the loss or error. 4. The network adjusts its weights slightly to reduce the error. 5. The process repeats across many examples." },
      { tag: "Big idea", title: "Slide 3", body: "One method used to update the weights is called backpropagation. It works backward through the network to calculate which weights contributed most to the mistake. Another key concept is gradient descent — the system taking small steps in the direction that lowers its error." },
      { tag: "Hot take", title: "Slide 4", body: "No single adjustment changes very much. The improvement comes from repetition. This is why large models require enormous computing resources and time to train — not because any individual step is complex, but because useful performance requires billions of them." },
    ],
    questions: [
  ...
  223: {
    ...
    title: "Deep Learning",
    stops: [
      { tag: "Fact", title: "Slide 1", body: "A neural network is made of layers. A shallow network has only a few hidden layers. A deep network has many more. That is what the word \"deep\" means in deep learning. It does not mean the system is thinking deeply. It means information passes through many layers of calculations." },
      { tag: "Example", title: "Slide 2", body: "In an image-recognition system, different layers may respond to different kinds of visual information: • Early layers may detect edges or lines • Later layers may detect textures or shapes • Deeper layers may combine those patterns into more complex features For example, a system may gradually move from noticing simple lines to identifying parts of a face, a wheel, or an animal." },
      { tag: "Big idea", title: "Slide 3", body: "No programmer writes out every one of those features by hand. The system develops useful internal patterns through training. Depth helps, but it is not magic. A deeper network is not automatically better at every task." },
      { tag: "Hot take", title: "Slide 4", body: "Deep learning drove the major breakthroughs of the 2010s, including AlexNet's success at image recognition in 2012 and AlphaGo defeating the world Go champion in 2016. These results came not from a new fundamental idea but from applying existing ideas at much greater scale." },
    ],
    questions: [
  ...
  224: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "ChatGPT is based on a type of neural network called a transformer. Transformers became important after researchers introduced them in a 2017 paper titled \"Attention Is All You Need.\" One of the key ideas is attention. Attention helps the model determine which parts of a sentence or conversation matter most at a given moment." },
      { tag: "Example", title: "Slide 2", body: "For example, consider the sentence: \"Maya dropped the glass on the floor because it was slippery.\" To understand what \"it\" refers to, the system has to use the surrounding words and context. Attention mechanisms allow the model to weigh different parts of the input against each other rather than processing words in strict sequence." },
      { tag: "Big idea", title: "Slide 3", body: "ChatGPT processes text as tokens. A token may be a full word, part of a word, punctuation, or even a single character. When ChatGPT responds, it generates one token at a time. At each step, it estimates what token should come next based on the conversation so far." },
      { tag: "Hot take", title: "Slide 4", body: "ChatGPT is not pulling a finished paragraph from a database. It is generating a response as it goes. That process involves a huge number of calculations and patterns learned during training — and it is why language models can be impressively fluent while still being confidently wrong." },
    ],
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `"Transformer"`, answer: true, verdict: "Correct.", explanation: "What type of neural network architecture underlies ChatGPT and similar language models? — Transformer" },
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `"A chunk of text — a word, part of a word, or punctuation — that the model processes as a unit"`, answer: true, verdict: "Correct.", explanation: "What is a token? — A chunk of text — a word, part of a word, or punctuation — that the model processes as a unit" },
  ...
  225: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "When YouTube suggests a video, Spotify builds a playlist, or Instagram arranges your feed, a recommendation system is making predictions about what may keep your attention. These systems learn from your behavior: what you watch, what you skip, what you replay, what you search, what you like, how long you pause before scrolling." },
      { tag: "Example", title: "Slide 2", body: "They also compare your behavior with patterns from other users. One common method is called collaborative filtering. Suppose two people liked many of the same movies. If one of them watches another movie and enjoys it, the system may recommend that movie to the other person too." },
      ...
      { tag: "Hot take", title: "Slide 4", body: "Recommendation algorithms do not simply reflect your interests. They can also shape them. Over time, they can narrow what you see and influence what you come to believe is normal, important, or desirable." },
    ],
    questions: [
  ...
  226: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "Computer vision is the field of AI focused on images and video. A digital image is made of pixels arranged in a grid. Each pixel is represented by numbers describing color and brightness. To a computer, an image begins as a large collection of numbers." },
      { tag: "Example", title: "Slide 2", body: "Many computer-vision systems use a type of neural network called a convolutional neural network, or CNN. A CNN scans small parts of an image and looks for visual patterns. Early layers may detect simple features such as edges or textures. Later layers may combine those signals into more complex shapes." },
      { tag: "Big idea", title: "Slide 3", body: "Computer vision can be used to: • Identify objects • Read text in images • Unlock a phone using a face scan • Analyze medical scans • Help robots navigate physical spaces In 2012, a deep-learning system called AlexNet performed extremely well in a major image-recognition competition called ImageNet. Its success helped drive much wider interest in deep learning." },
      { tag: "Hot take", title: "Slide 4", body: "Computer vision can be impressive. But identifying a cat in a photo is not the same as understanding what a cat is. These systems recognize patterns — they do not perceive, interpret, or comprehend in any meaningful sense." },
    ],
    questions: [
