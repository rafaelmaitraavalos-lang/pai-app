...
const wm_w2: Record<number, LessonData> = {
  221: {
    ...
    stops: [
      ...
      { tag: "Example", title: "Three Layers, One System", body: "A basic neural network has three parts: • Input layer: receives information, such as pixels, words, or numbers • Hidden layers: process and transform that information • Output layer: produces a result, such as a prediction or classification" },
      ...
      { tag: "Hot take", title: "Accuracy Takes Repetition", body: "At the beginning of training, a neural network is not very useful. Its predictions may be wildly inaccurate. The improvement comes entirely from the repeated adjustment of weights across enormous numbers of examples." },
    ],
    questions: [
  ...
  222: {
    ...
    stops: [
      { tag: "Fact", title: "Start Useless, Improve", body: "At the beginning of training, a neural network is not very useful. Its predictions may be wildly inaccurate. Training helps the network improve through a structured process." },
  ...
  223: {
    ...
    title: "Deep Learning",
    stops: [
      { tag: "Fact", title: "Depth Means Layers", body: "A neural network is made of layers. A shallow network has only a few hidden layers. A deep network has many more. That is what the word \"deep\" means in deep learning. It does not mean the system is thinking deeply. It means information passes through many layers of calculations." },
      { tag: "Example", title: "Layers Learn Features", body: "In an image-recognition system, different layers may respond to different kinds of visual information: • Early layers may detect edges or lines • Later layers may detect textures or shapes • Deeper layers may combine those patterns into more complex features For example, a system may gradually move from noticing simple lines to identifying parts of a face, a wheel, or an animal." },
      ...
      { tag: "Hot take", title: "Scale Made the Breakthrough", body: "Deep learning drove the major breakthroughs of the 2010s, including AlexNet's success at image recognition in 2012 and AlphaGo defeating the world Go champion in 2016. These results came not from a new fundamental idea but from applying existing ideas at much greater scale." },
    ],
    questions: [
  ...
  225: {
    ...
    stops: [
      { tag: "Fact", title: "Predicting Your Next Click", body: "When YouTube suggests a video, Spotify builds a playlist, or Instagram arranges your feed, a recommendation system is making predictions about what may keep your attention. These systems learn from your behavior: what you watch, what you skip, what you replay, what you search, what you like, how long you pause before scrolling." },
      { tag: "Example", title: "Collaborative Filtering Explained", body: "They also compare your behavior with patterns from other users. One common method is called collaborative filtering. Suppose two people liked many of the same movies. If one of them watches another movie and enjoys it, the system may recommend that movie to the other person too." },
      { tag: "Big idea", title: "Engagement Isn't Wellbeing", body: "Recommendation algorithms can be useful. They help people sort through more content than they could ever review on their own. But engagement is not the same as wellbeing. A video may hold your attention because it is funny, informative, upsetting, or infuriating. The system can measure your reaction without understanding whether the experience was good for you." },
      { tag: "Hot take", title: "Algorithms Shape Interests", body: "Recommendation algorithms do not simply reflect your interests. They can also shape them. Over time, they can narrow what you see and influence what you come to believe is normal, important, or desirable." },
    ],
    questions: [
  ...
  226: {
    ...
    stops: [
      ...
      { tag: "Big idea", title: "Vision Beyond Identification", body: "Computer vision can be used to: • Identify objects • Read text in images • Unlock a phone using a face scan • Analyze medical scans • Help robots navigate physical spaces In 2012, a deep-learning system called AlexNet performed extremely well in a major image-recognition competition called ImageNet. Its success helped drive much wider interest in deep learning." },
      { tag: "Hot take", title: "Recognition Isn't Understanding", body: "Computer vision can be impressive. But identifying a cat in a photo is not the same as understanding what a cat is. These systems recognize patterns — they do not perceive, interpret, or comprehend in any meaningful sense." },
    ],
    questions: [
  ...
  228: {
    ...
    stops: [
      { tag: "Fact", title: "Bias Comes from Data", body: "AI systems make mistakes. The important question is what kind of mistakes they make and how many people may be affected. Biased training data: AI systems learn from examples. If the examples reflect past unfairness, the system may repeat those patterns. A hiring algorithm trained on past hiring decisions may learn to favor the same groups that were favored in the past. The model is not prejudiced in a human sense. It is copying patterns from biased data." },
      { tag: "Example", title: "Performance Shifts with Context", body: "Distribution shift: A model may perform well in one setting and struggle in another. A system trained mostly on sunny roads may have trouble in heavy snow. A medical tool trained on one population may work less reliably for another." },
      { tag: "Big idea", title: "Overfitting Too Closely", body: "Overfitting: A model can become too closely tuned to its training data. It may perform well on examples it has already seen but struggle with unfamiliar ones. Instead of learning a general pattern, it has learned something too specific." },
      { tag: "Hot take", title: "Errors Multiply at Scale", body: "Errors at scale: A person can make one bad decision. An automated system can repeat the same bad decision thousands or millions of times. Automation does not invent bad decisions. It can mass-produce them. That is why AI failures are not only technical problems. They can become social, legal, and ethical problems too." },
    ],
    questions: [
