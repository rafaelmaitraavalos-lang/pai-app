...
const wm_w5: Record<number, LessonData> = {
  251: {
    ...
    stops: [
      { tag: "Fact", title: "Not If, But How Fast", body: "AI is unlikely to affect every job in the same way. The more important question is not whether AI will affect work, but how, at what pace, and who will be positioned to adapt." },
      { tag: "Example", title: "What's Easy to Automate", body: "Some tasks are easier to automate than others — especially tasks that are repetitive, structured, or based on patterns in data. Other work is harder to automate when it requires physical skill, trust, judgment, or experience in unpredictable situations." },
      { tag: "Big idea", title: "Tasks First, Then Jobs", body: "AI may not erase every job. It is more likely to reshape individual tasks first, changing what people actually do during the workday. That shift can still be significantly disruptive, particularly for workers in lower-wage, routine-heavy roles." },
      { tag: "Hot take", title: "Who Captures the Gains", body: "The bigger questions: Will new opportunities appear quickly enough? Will people have access to the retraining they need to adapt? Who captures the productivity gains — workers or the owners of the AI systems? These are policy and political questions, not just technical ones." },
    ],
    questions: [
  ...
  252: {
    ...
    stops: [
      { tag: "Fact", title: "Generation Without Experience", body: "AI systems can now generate images, music, writing, and video. That raises difficult questions about creativity that become more pressing as these systems improve." },
      { tag: "Example", title: "Lived Experience vs. Pattern", body: "AI-generated work is built from patterns learned from human-created material. The system can create something new, but it does so differently from a person. A human artist may create from memory, emotion, frustration, curiosity, or lived experience. An AI system does not have those experiences." },
      { tag: "Big idea", title: "Creators Face Displacement", body: "The rise of generative AI also affects people who make creative work professionally. Writers, designers, musicians, illustrators, and voice actors are already debating questions about consent, payment, copyright, and replacement. These debates will intensify as the technology improves." },
      { tag: "Hot take", title: "Who Benefits from Whose Work", body: "The question is not only whether AI can make something impressive. It is also who benefits, whose work made the system possible, and what happens to the people whose livelihoods depend on creativity." },
    ],
    questions: [
  ...
  253: {
    ...
    title: "Ai Safety",
    stops: [
      { tag: "Fact", title: "Keeping AI Under Control", body: "Some of the most serious researchers working on AI are focused on a field called AI safety — ensuring that AI systems do what their designers intend and do not cause unintended harm, including as they become more capable." },
      { tag: "Example", title: "Not Evil—Just Misaligned", body: "The concern is not that AI will \"turn evil.\" It is that powerful systems pursuing seemingly reasonable goals may pursue them in unexpected ways. As systems gain more autonomy, errors may be harder to correct. Competitive pressure to deploy quickly may lead to insufficient testing." },
      { tag: "Big idea", title: "Robustness, Corrigibility, Oversight", body: "Key concepts in AI safety: • Robustness: does the system work reliably across situations it was not trained for? • Corrigibility: can humans correct or override the system when needed? • Scalable oversight: how do humans maintain meaningful supervision as AI becomes more capable?" },
  ...
  254: {
    ...
    stops: [
      { tag: "Fact", title: "AI Could Go Either Way", body: "AI has the potential to reduce inequality. It also has the potential to make it significantly worse. Which outcome results depends on decisions — about access, ownership, and policy — that have not yet been finalized." },
      { tag: "Example", title: "Ways AI Deepens the Gap", body: "Ways AI could increase inequality: • Workers in routine jobs face displacement while owners of AI systems capture the productivity gains • Advanced AI tools are available primarily to wealthy individuals and institutions • AI systems that perform less well for underrepresented groups reinforce existing disadvantages" },
      { tag: "Big idea", title: "Ways AI Could Narrow It", body: "Ways AI could reduce inequality: • Access to expert-level assistance — legal, medical, educational — for people who could not previously afford it • Personalized learning tools that work regardless of school resources • AI that helps small businesses compete with larger ones • Scientific breakthroughs that address diseases disproportionately affecting lower-income countries" },
      { tag: "Hot take", title: "Ownership Shapes Distribution", body: "Who owns AI infrastructure matters. If the most powerful AI systems are concentrated in a few companies, the economic gains flow primarily to shareholders rather than broadly to society. Different policy choices could change that distribution — but they are choices that have to be made." },
    ],
    questions: [
  ...
  255: {
    ...
    stops: [
      { tag: "Fact", title: "AI Is Geopolitical", body: "AI is not only a technology story. It is a geopolitical story. Nations are competing for AI advantage — in military capability, economic productivity, and global influence — and that competition has real consequences." },
      { tag: "Example", title: "Two Powers, One Race", body: "The US and China are currently the leading AI powers by most measures: research output, AI patents, investment, and the number of frontier AI companies. This concentration has policy implications for the rest of the world." },
      { tag: "Big idea", title: "Military, Economy, Norms", body: "Why does AI matter geopolitically? Military applications — autonomous systems, intelligence analysis, surveillance — give AI strategic significance. Economic productivity advantages compound over time. The AI tools the world uses shape global data flows, technical standards, and norms." },
      { tag: "Hot take", title: "Racing Endangers Safety", body: "The risk of an AI arms race is real. Competitive pressure between nations may prioritize deployment speed over safety, testing, and alignment. Managing that race — potentially through international agreements — is one of the most consequential open questions in AI governance." },
    ],
    questions: [
  ...
  256: {
    ...
    stops: [
      { tag: "Fact", title: "Problem and Solution Both", body: "AI has a complicated relationship with climate change. It is both part of the problem and potentially part of the solution. Training large AI models consumes significant amounts of energy. Running AI systems at scale requires large data centers that use enormous amounts of electricity and water for cooling. As AI use expands, so does its energy demand." },
      { tag: "Example", title: "AI Helps the Climate Fight", body: "On the other side, AI tools are being applied to climate challenges: optimizing energy grids, improving climate modeling, accelerating materials science for better batteries, analyzing satellite data to track deforestation and emissions." },
      { tag: "Big idea", title: "Net Effect Is Unresolved", body: "The honest assessment is that AI may help address climate change while simultaneously contributing to it. The net effect depends on how AI is developed, how it is powered, and where the benefits of its application fall." },
      { tag: "Hot take", title: "Costs and Benefits Aren't Shared", body: "This is an active and unresolved debate. Whether AI's energy costs are worth its potential contributions to climate solutions depends partly on empirical questions about impact and partly on value judgments about who benefits and who bears the costs." },
    ],
    questions: [
  ...
  257: {
    ...
    stops: [
      { tag: "Fact", title: "You're Already in It", body: "AI is already part of your world. The relevant question is not whether to engage with it but how to do so critically and with your own interests and values intact." },
      { tag: "Example", title: "Verify Before You Trust", body: "Using AI well means knowing its limits. AI can be wrong. It can state falsehoods confidently. It reflects the biases in its training data. Treating AI output as a starting point to be verified — particularly for important decisions — is a better posture than treating it as authoritative." },
      ...
      { tag: "Hot take", title: "Questions Worth Asking", body: "Critical questions worth asking about any AI system: • Who built this, and what are their incentives? • What data was it trained on, and what biases might that introduce? • What is it optimizing for? • Who benefits when it works — and who bears the cost when it fails?" },
    ],
    questions: [
  ...
  258: {
    ...
    stops: [
      { tag: "Fact", title: "What We Know Now", body: "What we know: AI is already deeply embedded in daily life and is improving rapidly. It raises genuine ethical, social, and political questions that do not have clean technical answers." },
      { tag: "Example", title: "What Remains Unknown", body: "What we do not know: whether and when AGI will arrive; whether alignment problems can be solved before systems become significantly more powerful; how AI will reshape employment over the long run; how nations will manage AI competition; whether AI's benefits will be distributed broadly or concentrated." },
      { tag: "Big idea", title: "Everyone Gets a Say", body: "Who gets to help answer those questions? Researchers, engineers, policymakers, ethicists, educators, journalists, activists, voters — and the people studying those questions now. The most important AI problems are not purely technical. They are about fairness, power, trust, accountability, and what kind of future we are collectively willing to build." },
      { tag: "Hot take", title: "Understanding Is Power", body: "The more you understand about how AI works, what it cannot do, and what interests shape it, the better positioned you are to engage with those questions — as a user, a citizen, and potentially as someone who builds or governs these systems." },
    ],
    questions: [
