...
const wm_w5: Record<number, LessonData> = {
  ...
  255: {
    ...
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `The US and China are currently the leading AI powers by most measures.`, answer: true, verdict: "Correct.", explanation: "Which two countries are currently the leading AI powers by most measures? — US and China" },
  ...
  257: {
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Users have no meaningful agency in how they engage with AI systems.`, answer: false, verdict: "Correct.", explanation: "True or false: Users have no meaningful agency in how they engage with AI systems." },
    ],
  },
  258: {
    id: 258, worldId: 205,
