...
const wm_w5: Record<number, LessonData> = {
  ...
  253: {
    ...
    stops: [
      ...
      { tag: "Big idea", title: "Slide 3", body: "Key concepts in AI safety: • Robustness: does the system work reliably across situations it was not trained for? • Corrigibility: can humans correct or override the system when needed? • Scalable oversight: how do humans maintain meaningful supervision as AI becomes more capable?" },
  ...
  254: {
    ...
    stops: [
      ...
      { tag: "Example", title: "Slide 2", body: "Ways AI could increase inequality: • Workers in routine jobs face displacement while owners of AI systems capture the productivity gains • Advanced AI tools are available primarily to wealthy individuals and institutions • AI systems that perform less well for underrepresented groups reinforce existing disadvantages" },
      { tag: "Big idea", title: "Slide 3", body: "Ways AI could reduce inequality: • Access to expert-level assistance — legal, medical, educational — for people who could not previously afford it • Personalized learning tools that work regardless of school resources • AI that helps small businesses compete with larger ones • Scientific breakthroughs that address diseases disproportionately affecting lower-income countries" },
  ...
  256: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "AI has a complicated relationship with climate change. It is both part of the problem and potentially part of the solution. Training large AI models consumes significant amounts of energy. Running AI systems at scale requires large data centers that use enormous amounts of electricity and water for cooling. As AI use expands, so does its energy demand." },
  ...
  257: {
    ...
    stops: [
      ...
      { tag: "Hot take", title: "Slide 4", body: "Critical questions worth asking about any AI system: • Who built this, and what are their incentives? • What data was it trained on, and what biases might that introduce? • What is it optimizing for? • Who benefits when it works — and who bears the cost when it fails?" },
    ],
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `"True or false: Users have no meaningful agency in how they engage with AI systems."`, answer: false, verdict: "Correct.", explanation: "True or false: Users have no meaningful agency in how they engage with AI systems." },
    ],
  },
  258: {
    id: 258, worldId: 205,
