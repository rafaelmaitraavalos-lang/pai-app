...
const we5: Record<number, LessonData> = {
  44: {
    id: 44, worldId: 7, title: "What Is PAI's Brain?",
    stops: [
  ...
  45: {
    id: 45, worldId: 7, title: 'How PAI Learns',
    stops: [
  ...
  46: {
    id: 46, worldId: 7, title: 'PAI Gets Smarter With More Practice',
    stops: [
  ...
  47: {
    id: 47, worldId: 7, title: 'How Does PAI Talk With You?',
    stops: [
  ...
  48: {
    id: 48, worldId: 7, title: 'How PAI Decides What to Show You',
    stops: [
  ...
  49: {
    id: 49, worldId: 7, title: 'How PAI Sees Pictures',
    stops: [
  ...
  50: {
    id: 50, worldId: 7, title: 'The Mystery Inside PAI',
    stops: [
  ...
  51: {
    id: 51, worldId: 7, title: 'When PAI Gets Things Wrong',
    stops: [
