...
const we6: Record<number, LessonData> = {
  52: {
    ...
    questions: [
      { difficulty: 'Easy', tag: 'Big idea', stopTitle: 'What is Ethics?', question: `"Ethics means thinking about what is right and wrong and trying to make good choices."`, answer: true, verdict: 'Correct!', explanation: "The answer is TRUE. Ethics is about making good choices — and AI needs ethics too. When AI talks to millions of people, even one small wrong choice can cause a lot of harm." },
      { difficulty: 'Easy', tag: 'Fact', stopTitle: 'The Bias Problem', question: `"AI can be biased if it learned from information that left some people out."`, answer: true, verdict: 'Correct!', explanation: "The answer is TRUE. AI is not trying to be mean — it just learned from unfair patterns. That is why the information AI learns from is so important to get right." },
      { difficulty: 'Medium', tag: 'Fact', stopTitle: 'The Consent Problem', question: `"Everyone whose writing or art AI learned from said 'yes, you can use my work.'"`, answer: false, verdict: 'Not quite!', explanation: "The answer is FALSE. Actually, not everyone gave permission! AI learned from millions of things people made, but many people were never asked. This is a big question people are still working to solve." },
    ],
  },
