...
const wm_w3: Record<number, LessonData> = {
  ...
  233: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "AI systems often depend on data. That data may include: location history, search activity, browsing habits, purchases, photos, voice recordings, health information, social-media behavior. Companies can use this information to personalize services, recommend products, detect fraud, or train new systems. Some uses are helpful. Others raise serious concerns." },
  ...
  236: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "Democracy depends on people being able to argue about shared facts. AI makes that harder. Deepfakes are AI-generated images, audio, or video that make it appear as if a real person said or did something they never said or did. A convincing fake video can spread quickly online. Even after it has been corrected, some viewers may continue to believe it." },
