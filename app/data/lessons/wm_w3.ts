...
const wm_w3: Record<number, LessonData> = {
  ...
  233: {
    ...
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `AI systems commonly depend on data such as location, search activity, purchases, photos, health data, and social behavior.`, answer: true, verdict: "Correct.", explanation: "AI systems feed on your data trail — location, searches, purchases, photos, health info, social activity. The more they know, the better they predict you." },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `A data broker is a company that collects and sells personal information.`, answer: true, verdict: "Correct.", explanation: "Data brokers are companies whose whole business is collecting your personal information and selling it. Most people have never heard of them, yet the brokers know plenty about most people." },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Technical consent means clicking "agree," while meaningful consent means actually understanding the choice and having a genuine option to decline.`, answer: true, verdict: "Correct.", explanation: "Clicking 'agree' is technical consent — it counts legally. Meaningful consent means truly understanding the deal and having a real option to say no. There is often a canyon between the two." },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Privacy policies are generally written to ensure users fully understand how their data will be used.`, answer: false, verdict: "Correct.", explanation: "Privacy policies are mostly written by lawyers to protect companies, not to inform you. They are long, dense, and famously unread — very few are designed for understanding." },
    ],
  },
  234: {
    id: 234, worldId: 203,
