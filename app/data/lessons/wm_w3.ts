...
const wm_w3: Record<number, LessonData> = {
  231: {
    ...
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Repetitive, structured, pattern-based tasks are generally more susceptible to AI automation.`, answer: true, verdict: "Correct.", explanation: "Which type of tasks are generally more susceptible to AI automation? — Repetitive, structured, pattern-based tasks" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `A nurse noticing subtle changes in a patient's condition is an example of a job that is easy to automate.`, answer: false, verdict: "Correct.", explanation: "Which of these jobs is hardest to automate? — A nurse noticing subtle changes in a patient's condition" },
  ...
  233: {
    ...
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `AI systems commonly depend on data such as location, search activity, purchases, photos, health data, and social behavior.`, answer: true, verdict: "Correct.", explanation: "What types of data do AI systems commonly depend on? — Location, search activity, purchases, photos, health data, and social behavior" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `A data broker is a company that collects and sells personal information.`, answer: true, verdict: "Correct.", explanation: "What is a data broker? — A company that collects and sells personal information" },
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Privacy policies are generally written to ensure users fully understand how their data will be used.`, answer: false, verdict: "Correct.", explanation: "True or false: Privacy policies are generally written to ensure users fully understand how their data will be used." },
    ],
  },
  234: {
    id: 234, worldId: 203,
  ...
  237: {
    ...
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `AlphaFold made a major scientific contribution in the field of protein structure prediction.`, answer: true, verdict: "Correct.", explanation: "In which field did AlphaFold make a major scientific contribution? — Protein structure prediction" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `AI is particularly useful for processing scientific data because it can process data at a scale no human research team could match.`, answer: true, verdict: "Correct.", explanation: "What makes AI particularly useful for processing scientific data? — AI can process data at a scale no human research team could match" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `AI-generated scientific results still need to be testable, reproducible, and subject to peer review.`, answer: true, verdict: "Correct.", explanation: "What requirement does AI-generated scientific work still need to meet? — Results must be testable, reproducible, and subject to peer review" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `AI replaces the need for evidence, transparency, and careful review in the scientific process.`, answer: false, verdict: "Correct.", explanation: "What does AI not replace in the scientific process? — The need for evidence, transparency, reproducibility, and careful critical review" },
    ],
  },
  238: {
    id: 238, worldId: 203,
    ...
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `A bank's system detecting an unusual transaction is an example of AI operating in daily life.`, answer: true, verdict: "Correct.", explanation: "Which of these is an example of AI operating in daily life? — A bank's system detecting an unusual transaction" },
