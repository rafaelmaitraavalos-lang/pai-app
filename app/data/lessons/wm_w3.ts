...
const wm_w3: Record<number, LessonData> = {
  231: {
    ...
    title: "AI And Jobs",
    stops: [
      { tag: "Fact", title: "Slide 1", body: "AI is unlikely to affect every job in the same way. Some tasks are easier to automate than others, especially tasks that are repetitive, structured, or based on patterns in data. Examples may include: data entry, basic customer-service responses, document sorting, some accounting tasks, some forms of research or screening." },
      { tag: "Example", title: "Slide 2", body: "Other work is harder to automate, especially when it requires physical skill, trust, judgment, or experience in unpredictable situations.\nA plumber working in an unfamiliar house has to adapt constantly. A teacher has to respond to the needs of different students. A nurse may notice subtle changes in a patient that are difficult to reduce to a checklist." },
      { tag: "Big idea", title: "Slide 3", body: "AI may not erase every job. It is more likely to reshape individual tasks first, changing what people actually do during the workday." },
      { tag: "Hot take", title: "Slide 4", body: "The bigger question is whether new opportunities will appear quickly enough and whether people will have access to the training needed to adapt." },
    ],
    questions: [
  ...
  232: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "AI systems can now generate images, music, writing, and video. That raises difficult questions about creativity.\nAI-generated work is built from patterns learned from human-created material. The system can create something new, but it does so differently from a person." },
      { tag: "Example", title: "Slide 2", body: "A human artist may create from memory, emotion, frustration, curiosity, or lived experience. An AI system does not have those experiences. It generates patterns based on training. This does not make every AI-generated image or paragraph worthless. But it changes the conversation." },
      { tag: "Big idea", title: "Slide 3", body: "The rise of generative AI also affects people who make creative work professionally. Writers, designers, musicians, illustrators, and voice actors are already debating questions about consent, payment, copyright, and replacement." },
      { tag: "Hot take", title: "Slide 4", body: "The question is not only whether AI can make something impressive. It is also who benefits, whose work made the system possible, and what happens to the people whose jobs depend on creativity." },
    ],
    questions: [
  ...
  233: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "AI systems often depend on data. That data may include: location history, search activity, browsing habits, purchases, photos, voice recordings, health information, social-media behavior.\nCompanies can use this information to personalize services, recommend products, detect fraud, or train new systems. Some uses are helpful. Others raise serious concerns." },
      { tag: "Example", title: "Slide 2", body: "Facial-recognition tools can identify people from camera footage. Data brokers can collect and sell information about individuals. Apps may gather far more data than users realize." },
      { tag: "Big idea", title: "Slide 3", body: "Most people make a trade without thinking about it very much: convenience in exchange for information. The problem is that the terms of that trade are often unclear. Privacy policies are long, complicated, and easy to ignore. A person may technically click \"agree\" without truly understanding what they have agreed to." },
      { tag: "Hot take", title: "Slide 4", body: "There is a difference between technical consent and meaningful consent. Technical consent means someone clicked a button. Meaningful consent means the person understood the choice and made it freely. Those are not always the same thing." },
    ],
    questions: [
  ...
  234: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "Healthcare is one of the most promising uses of AI. It is also one of the highest-stakes.\nAI systems can help analyze medical images, identify patterns, organize records, and support doctors as they make decisions. Some systems have performed very well on specific tasks, such as detecting signs of disease in scans." },
      { tag: "Example", title: "Slide 2", body: "AI can also support scientific research. AlphaFold, a system developed by DeepMind, made major progress in predicting protein structures. This was an important advance because the shape of a protein affects how it functions. Predicting those shapes had been an unsolved problem for fifty years." },
      { tag: "Big idea", title: "Slide 3", body: "But healthcare is not a setting where \"mostly accurate\" is always good enough. A medical system has to be tested carefully. It must work for different groups of patients, not only the people represented in the original training data." },
      { tag: "Hot take", title: "Slide 4", body: "Access matters too. If the most advanced tools are available only at wealthy hospitals, AI could widen existing health gaps instead of reducing them." },
    ],
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: "\"It solved protein structure prediction, a scientific problem unsolved for fifty years\"", answer: true, verdict: "Correct.", explanation: "What did AlphaFold achieve? \u2014 It solved protein structure prediction, a scientific problem unsolved for fifty years" },
  ...
  235: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "Students are already using AI tools to brainstorm, summarize, explain difficult ideas, write code, and draft essays. Schools are also using AI for tutoring, grading support, scheduling, and personalized learning." },
      { tag: "Example", title: "Slide 2", body: "These tools can be helpful. A student who is confused about a concept can ask for another explanation. A personalized system can slow down when a student is struggling and move faster when they are ready." },
      { tag: "Big idea", title: "Slide 3", body: "But AI also makes academic integrity more complicated. If a chatbot can write an essay or solve a problem set, how can a teacher know what a student actually understands?" },
      { tag: "Hot take", title: "Slide 4", body: "Some schools are responding with more in-class writing, oral exams, project-based learning, and assignments that require students to explain their thinking.\nStudents are going to use AI. The real question is whether it helps them think or gives them a polished way to avoid thinking." },
    ],
    questions: [
  ...
  236: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "Democracy depends on people being able to argue about shared facts. AI makes that harder.\nDeepfakes are AI-generated images, audio, or video that make it appear as if a real person said or did something they never said or did. A convincing fake video can spread quickly online. Even after it has been corrected, some viewers may continue to believe it." },
      { tag: "Example", title: "Slide 2", body: "AI can also make misinformation easier to produce at scale. A single person may be able to generate many versions of the same false claim and tailor them to different audiences." },
      { tag: "Big idea", title: "Slide 3", body: "Recommendation systems matter too. Social-media platforms often rank content partly based on engagement. Outrage, fear, and conflict can keep people watching and sharing. Algorithms did not invent political division. But they can accelerate it, quietly turning a few clicks into a narrower version of the world." },
      { tag: "Hot take", title: "Slide 4", body: "Detection tools exist. Researchers are developing systems to identify AI-generated content. But progress in generating convincing fakes has consistently outpaced the development of reliable detection methods." },
    ],
    questions: [
  ...
  237: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "Science often involves enormous amounts of information. AI can help researchers process data, identify patterns, and test ideas more quickly. It is being used in areas such as: climate modeling, protein research, genetics, astronomy, materials science, and particle physics." },
      { tag: "Example", title: "Slide 2", body: "AI systems can help analyze large datasets that would take humans far longer to review. In astronomy, for example, AI can scan telescope data for anomalies \u2014 unusual signals, potential new objects \u2014 that human researchers might take years to find manually." },
      { tag: "Big idea", title: "Slide 3", body: "But AI-based science still has to survive the same test as any other science: Can other researchers understand, evaluate, and reproduce the result? AI can speed up discovery. It does not replace the need for evidence, transparency, and careful review." },
      { tag: "Hot take", title: "Slide 4", body: "AI can find patterns faster and suggest hypotheses. But \"an AI found a pattern\" is not a scientific finding until it has been tested, verified, and subjected to peer review." },
    ],
    questions: [
  ...
  238: {
    ...
    stops: [
      ...
      { tag: "Hot take", title: "Slide 4", body: "Understanding that gives you more control \u2014 not over the systems themselves, but over how you engage with them and what assumptions you bring to information they serve you." },
    ],
    questions: [
