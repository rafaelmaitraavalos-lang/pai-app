...
const wm_w2_pt: Record<number, LessonData> = {
  321: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "Muitos sistemas modernos de IA usam uma estrutura chamada rede neural. O nome é baseado no cérebro. O cérebro humano contém bilhões de neurônios conectados uns aos outros. Essas conexões mudam à medida que as pessoas aprendem. As redes neurais artificiais pegam emprestada uma versão muito simplificada dessa ideia. Elas não são cérebros em miniatura. São sistemas matemáticos compostos por unidades conectadas, frequentemente chamadas de nós." },
      { tag: "Example", title: "Slide 2", body: "Uma rede neural básica tem três partes: • Camada de entrada: recebe informações, como pixels, palavras ou números • Camadas ocultas: processam e transformam essas informações • Camada de saída: produz um resultado, como uma previsão ou classificação" },
      { tag: "Big idea", title: "Slide 3", body: "As conexões entre os nós possuem valores chamados de pesos. Um peso determina a intensidade com que uma informação influencia a outra. Treinar uma rede neural significa ajustar esses pesos até que o sistema se torne melhor em sua tarefa." },
      { tag: "Hot take", title: "Slide 4", body: "No início do treinamento, uma rede neural não é muito útil. Suas previsões podem ser extremamente imprecisas. A melhoria vem inteiramente do ajuste repetido dos pesos ao longo de um número enorme de exemplos." },
    ],
    questions: [
  ...
  322: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "No início do treinamento, uma rede neural não é muito útil. Suas previsões podem ser extremamente imprecisas. O treinamento ajuda a rede a melhorar por meio de um processo estruturado." },
      { tag: "Example", title: "Slide 2", body: "O processo de treinamento: 1. A rede faz uma previsão. 2. A previsão é comparada com a resposta correta. 3. O sistema mede a diferença. Essa diferença é chamada de perda (loss) ou erro. 4. A rede ajusta levemente seus pesos para reduzir o erro. 5. O processo se repete várias e várias vezes." },
      { tag: "Big idea", title: "Slide 3", body: "Um dos métodos usados para atualizar os pesos é chamado de backpropagation. Ele funciona de trás para frente na rede para calcular quais pesos mais contribuíram para o erro. Outro conceito importante é o gradient descent — o sistema dando pequenos passos na direção que diminui o seu erro." },
      { tag: "Hot take", title: "Slide 4", body: "Nenhum ajuste individual muda muita coisa. A melhoria vem da repetição. É por isso que grandes modelos exigem recursos computacionais enormes e tempo para treinar — não porque qualquer etapa individual seja complexa, mas porque um desempenho útil requer bilhões delas." },
    ],
    questions: [
  ...
  325: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "Quando o YouTube sugere um vídeo, o Spotify cria uma playlist ou o Instagram organiza o seu feed, um sistema de recomendação está fazendo previsões sobre o que pode reter a sua atenção. Esses sistemas aprendem com o seu comportamento: a que você assiste, o que você pula, o que você repete, o que você pesquisa, do que você gosta, quanto tempo você pausa antes de rolar a tela." },
      { tag: "Example", title: "Slide 2", body: "Eles também comparam o seu comportamento com padrões de outros usuários. Um método comum é chamado de filtragem colaborativa. Suponha que duas pessoas tenham gostado de muitos filmes em comum. Se uma delas assiste a outro filme e gosta, o sistema pode recomendar esse filme para a outra pessoa também." },
      { tag: "Big idea", title: "Slide 3", body: "Os algoritmos de recomendação podem ser úteis. Eles ajudam as pessoas a filtrar muito mais conteúdo do que elas conseguiriam analisar sozinhas. Mas engajamento não é a mesma coisa que bem-estar. Um vídeo pode prender sua atenção porque é engraçado, informativo, perturbador ou enfurecedor. O sistema consegue medir a sua reação sem entender se a experiência foi boa para você." },
      { tag: "Hot take", title: "Slide 4", body: "Os algoritmos de recomendação não refletem simplesmente os seus interesses. Eles também podem moldá-los. Com o tempo, podem estreitar o que você vê e influenciar o que você passa a acreditar ser normal, importante ou desejável." },
    ],
    questions: [
  ...
  328: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "Os sistemas de IA cometem erros. A pergunta importante é que tipo de erros eles cometem e quantas pessoas podem ser afetadas. Dados de treinamento enviesados: Os sistemas de IA aprendem com base em exemplos. Se os exemplos refletirem injustiças do passado, o sistema poderá repetir esses padrões. Um algoritmo de contratação treinado com base em decisões de contratação anteriores pode aprender a favorecer os mesmos grupos que foram favorecidos no passado. O modelo não tem preconceito no sentido humano. Ele está copiando padrões de dados enviesados." },
      { tag: "Example", title: "Slide 2", body: "Desvio de distribuição (Distribution shift): Um modelo pode ter um bom desempenho em um cenário e ter dificuldades em outro. Um sistema treinado principalmente em estradas ensolaradas pode ter problemas sob neve forte. Uma ferramenta médica treinada em uma população pode funcionar de forma menos confiável para outra." },
      { tag: "Big idea", title: "Slide 3", body: "Overfitting: Um modelo pode ficar excessivamente ajustado aos seus dados de treinamento. Ele pode ter um bom desempenho em exemplos que já viu, mas ter dificuldades com exemplos desconhecidos. Em vez de aprender um padrão geral, ele aprendeu algo específico demais." },
      { tag: "Hot take", title: "Slide 4", body: "Erros em escala: Uma pessoa pode tomar uma decisão ruim. Um sistema automatizado pode repetir a mesma decisão ruim milhares ou milhões de vezes. A automação não inventa decisões ruins. Ela pode produzi-las em massa. É por isso que as falhas da IA não são apenas problemas técnicos. Elas podem se tornar problemas sociais, legais e éticos também." },
    ],
    questions: [
