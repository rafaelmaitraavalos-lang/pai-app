...
const wm_w2_pt: Record<number, LessonData> = {
  321: {
    ...
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Uma rede neural é um sistema matemático de nós conectados que processa informações.`, answer: true, verdict: "Correto.", explanation: "O que é uma rede neural? — Um sistema matemático de nós conectados que processa informações" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Os pesos em uma rede neural são valores que controlam a intensidade com que um nó influencia o outro.`, answer: true, verdict: "Correto.", explanation: "O que são pesos em uma rede neural? — Valores que controlam a intensidade com que um nó influencia o outro" },
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `A camada de saída de uma rede neural recebe os dados brutos de entrada antes de qualquer processamento.`, answer: false, verdict: "Correto.", explanation: "Qual parte de uma rede neural produz o resultado final? — Camada de saída" },
    ],
  },
  322: {
    id: 322, worldId: 262,
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `O gradient descent é o processo do sistema dando pequenos passos na direção que reduz seu erro.`, answer: true, verdict: "Correto.", explanation: "O que é gradient descent? — O processo do sistema dando pequenos passos na direção que reduz seu erro" },
  ...
  323: {
    ...
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `"Profundo" (deep) em deep learning significa que a rede neural contém muitas camadas de processamento.`, answer: true, verdict: "Correto.", explanation: "O que \"profundo\" (deep) significa em deep learning? — A rede neural contém muitas camadas de processamento" },
  ...
  326: {
    ...
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `No nível mais básico, uma imagem digital é uma grade de pixels, cada um representado por números de cor e brilho.`, answer: true, verdict: "Correto.", explanation: "No nível mais básico, o que é uma imagem digital para um computador? — Uma grade de pixels, cada um representado por números de cor e brilho" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `O tipo de rede neural mais comumente usado para visão computacional é a Rede Neural Convolucional (CNN).`, answer: true, verdict: "Correto.", explanation: "Que tipo de rede neural é mais comumente usado para visão computacional? — Rede Neural Convolucional (CNN)" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Analisar imagens médicas em busca de sinais de doenças é uma aplicação real da visão computacional.`, answer: true, verdict: "Correto.", explanation: "Qual é uma aplicação real da visão computacional? — Analisar imagens médicas em busca de sinais de doenças" },
