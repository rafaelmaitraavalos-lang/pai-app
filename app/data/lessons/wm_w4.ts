...
const wm_w4: Record<number, LessonData> = {
  241: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "Ethics is the branch of philosophy that asks how people should act. What do we owe one another? What counts as harm? How should we make decisions when values conflict? Several major ethical frameworks often appear in discussions about AI." },
  ...
  243: {
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `"True or false: Privacy policies are typically designed to clearly inform users how their data will be used."`, answer: false, verdict: "Correct.", explanation: "True or false: Privacy policies are typically designed to clearly inform users how their data will be used." },
    ],
  },
  244: {
    id: 244, worldId: 204,
  ...
  247: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "The alignment problem asks a simple question: How do we make sure an AI system does what people actually want? The difficulty is that people do not always say exactly what they mean." },
      ...
      { tag: "Big idea", title: "Slide 3", body: "This problem appears in many forms: • A recommendation algorithm promotes inflammatory content • A moderation system blocks harmless posts • A grading tool rewards formulaic writing • A system finds a shortcut that improves a score without solving the real problem" },
