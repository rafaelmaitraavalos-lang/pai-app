...
const wm_w4: Record<number, LessonData> = {
  241: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "Ethics is the branch of philosophy that asks how people should act. What do we owe one another? What counts as harm? How should we make decisions when values conflict?\nSeveral major ethical frameworks often appear in discussions about AI." },
      { tag: "Example", title: "Slide 2", body: "Consequentialism judges actions by their outcomes. An action is considered good if it produces the best overall result. The difficulty is that outcomes can be hard to predict. People may also disagree about what counts as the \"best\" result and who should benefit most." },
      { tag: "Big idea", title: "Slide 3", body: "Deontology focuses on duties and rules. Some actions may be wrong even if they lead to a good outcome. The difficulty is that rules can conflict. Strict rule-following may also lead to strange results in unusual situations." },
      { tag: "Hot take", title: "Slide 4", body: "Virtue ethics asks a different question: What kind of person should I be? It focuses on qualities such as honesty, fairness, courage, and compassion. The difficulty is that character alone does not always tell someone exactly what to do in a hard situation.\nAI ethics matters because AI systems can affect large numbers of people. Ethical questions are not separate from the technology." },
    ],
    questions: [
  ...
  242: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "AI bias is often described as if it were a simple technical bug. It is usually more complicated.\nAI systems learn from data. If the data reflects past inequality, the system may reproduce it. A hiring algorithm trained on past hiring decisions may learn to favor the same groups that were favored in the past. The model is not prejudiced in a human sense. It is copying patterns from biased data." },
      { tag: "Example", title: "Slide 2", body: "The harder question is what fairness should mean. There are several possible definitions:\n\u2022 Demographic parity: different groups should receive similar outcomes\n\u2022 Equal accuracy: the system should perform equally well for different groups\n\u2022 Individual fairness: similar individuals should be treated similarly" },
      { tag: "Big idea", title: "Slide 3", body: "These goals can conflict. A system may improve one measure of fairness while making another worse. Better code can reduce bias. It cannot decide what fairness should mean. That still requires human judgment." },
      { tag: "Hot take", title: "Slide 4", body: "This means AI bias is not just a technical problem. It is a values problem \u2014 about which conception of fairness a society wants to prioritize. That question cannot be answered by engineers alone." },
    ],
    questions: [
  ...
  243: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "Many AI systems rely on data collected from people who did not fully understand how it would be used. Meaningful consent requires more than clicking \"agree.\" A person should understand what they are accepting. They should also have a real choice to say no." },
      { tag: "Example", title: "Slide 2", body: "In practice, that is difficult. Terms-of-service agreements may be dozens of pages long. Privacy policies may be written in legal language. Opting out may mean losing access to a service people depend on." },
      { tag: "Big idea", title: "Slide 3", body: "There is a difference between technical consent and meaningful consent. Technical consent means someone clicked a button. Meaningful consent means the person understood the choice and made it freely. Those are not always the same thing." },
      { tag: "Hot take", title: "Slide 4", body: "The consent problem extends to creators. AI image generators and language models were trained on enormous amounts of human-created content \u2014 much of it scraped from the internet without the knowledge, consent, or compensation of the people who created it. The legal and ethical status of this practice is actively contested." },
    ],
    questions: [
  ...
  244: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "When an AI system causes harm, who is responsible? The answer is not always obvious.\nSeveral groups may be involved: researchers who designed the model, companies that trained it, engineers who deployed it, businesses that used it, people who relied on its output. Responsibility can become spread across the entire chain. Each group may point to someone else. That creates an accountability gap." },
      { tag: "Example", title: "Slide 2", body: "Closing the gap requires clearer rules about who is responsible when automated systems cause harm. Some governments are beginning to create laws for this. The European Union's AI Act is one major attempt to regulate AI systems based on risk." },
      { tag: "Big idea", title: "Slide 3", body: "The details will continue to change, but the basic question is simple: Who is accountable when an automated system affects someone's life?" },
      { tag: "Hot take", title: "Slide 4", body: "This question becomes more urgent as AI systems are deployed in higher-stakes contexts \u2014 credit decisions, medical recommendations, criminal risk assessments \u2014 where the consequences of errors fall on specific people who had no role in designing the system." },
    ],
    questions: [
  ...
  245: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "People often want AI systems to explain their decisions. That seems reasonable. If a system affects whether someone receives a loan, gets flagged as a risk, or receives a medical recommendation, the person may want to know why." },
      { tag: "Example", title: "Slide 2", body: "The difficulty is that some powerful AI systems are hard to explain. A deep neural network does not always make decisions through a short list of readable rules. Its output may emerge from many calculations spread across a large network." },
      { tag: "Big idea", title: "Slide 3", body: "Researchers are trying to make AI systems more interpretable. But explanations can be imperfect. A simplified explanation may not capture everything happening inside the model." },
      { tag: "Hot take", title: "Slide 4", body: "In high-stakes settings, accuracy is not the only goal. People also need transparency, oversight, and a way to challenge mistakes. These are not optional features \u2014 they are prerequisites for systems that affect people's lives to operate legitimately." },
    ],
    questions: [
  ...
  246: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "AI systems are often designed to predict behavior. That can be useful. A recommendation app may help someone discover music they love. A navigation app may suggest a faster route.\nBut systems that predict behavior can also influence behavior. Social-media feeds, targeted ads, and recommendation algorithms may be designed to keep users engaged for as long as possible." },
      { tag: "Example", title: "Slide 2", body: "The line between persuasion and manipulation matters. Persuasion gives someone information and reasons. Manipulation takes advantage of a person's vulnerabilities or emotions in ways they may not notice." },
      { tag: "Big idea", title: "Slide 3", body: "A platform does not need to lie to influence someone. It can shape what they see, when they see it, and how often they see it. That is why attention has value." },
      { tag: "Hot take", title: "Slide 4", body: "Autonomy \u2014 the capacity to form your own views and make your own decisions \u2014 is gradually compromised when the information environment you inhabit is shaped by systems optimizing for something other than your understanding or wellbeing." },
    ],
    questions: [
  ...
  247: {
    ...
    stops: [
      { tag: "Fact", title: "Slide 1", body: "The alignment problem asks a simple question: How do we make sure an AI system does what people actually want?\nThe difficulty is that people do not always say exactly what they mean." },
      { tag: "Example", title: "Slide 2", body: "Imagine telling a system to maximize the number of clicks on a platform. It may discover that outrage and anxiety increase engagement. Technically, it is succeeding. But it is not producing the result people actually wanted." },
      { tag: "Big idea", title: "Slide 3", body: "This problem appears in many forms:\n\u2022 A recommendation algorithm promotes inflammatory content\n\u2022 A moderation system blocks harmless posts\n\u2022 A grading tool rewards formulaic writing\n\u2022 A system finds a shortcut that improves a score without solving the real problem" },
      { tag: "Hot take", title: "Slide 4", body: "Human values are complicated. They depend on context. People disagree about them. Even when people agree, they may struggle to explain their values precisely. Alignment is the challenge of translating human goals into instructions a system can follow reliably. That remains an open problem." },
    ],
    questions: [
  ...
  248: {
    ...
    title: "Who Decides?",
    stops: [
      { tag: "Fact", title: "Slide 1", body: "AI development is concentrated in a relatively small number of companies, research labs, and governments. The decisions made by those organizations may affect people around the world. Who should set the rules?" },
      { tag: "Example", title: "Slide 2", body: "Companies and researchers: Supporters argue that experts and developers understand the technology best and can move quickly. The risk is that a small group of private organizations may make decisions that affect everyone else.\nGovernments: Supporters argue that elected institutions should regulate powerful technologies. The risk is that governments may move slowly or lack technical expertise." },
      { tag: "Big idea", title: "Slide 3", body: "International organizations: Supporters argue that AI is global and needs international oversight. The risk is that countries may disagree about rules or refuse to cooperate.\nAffected communities: Supporters argue that people directly affected by AI systems should have a voice in how those systems are used. The difficulty is making that participation meaningful rather than symbolic." },
      { tag: "Hot take", title: "Slide 4", body: "There is no perfect answer. But leaving major decisions entirely to a small group of engineers and executives is not a neutral choice. It is a choice about who gets power. That is one of the most important questions in AI ethics." },
    ],
    questions: [
