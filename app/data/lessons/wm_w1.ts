...
const wm_w1: Record<number, LessonData> = {
  ...
  212: {
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: "\"It adjusts slightly to reduce the error\"", answer: true, verdict: "Correct.", explanation: "After a wrong prediction, what happens? \u2014 It adjusts slightly to reduce the error" },
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: "\"A wide range including spam detection, music recommendation, and medical imaging\"", answer: true, verdict: "Correct.", explanation: "Which tasks can machine learning be applied to? \u2014 A wide range including spam detection, music recommendation, and medical imaging" },
    ],
  },
  213: {
    id: 213, worldId: 201,
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: "\"He shifted focus to whether behavior is indistinguishable from thinking\"", answer: true, verdict: "Correct.", explanation: "How did Turing reframe machine intelligence? \u2014 He shifted focus to whether behavior is indistinguishable from thinking" },
  ...
  214: {
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: "\"It can fail at tasks requiring genuine reasoning or common sense outside its training\"", answer: true, verdict: "Correct.", explanation: "What makes AI \"surprisingly fragile\" in some areas? \u2014 It can fail at tasks requiring genuine reasoning or common sense outside its training" },
    ],
  },
  215: {
    id: 215, worldId: 201,
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: "\"A recommendation algorithm deciding which job postings you see\"", answer: true, verdict: "Correct.", explanation: "Which is a potentially consequential AI decision people often don't notice? \u2014 A recommendation algorithm deciding which job postings you see" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: "\"More control over how you interact with those systems\"", answer: true, verdict: "Correct.", explanation: "What does awareness of AI decision-making give you? \u2014 More control over how you interact with those systems" },
    ],
  },
  216: {
    id: 216, worldId: 201,
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: "\"Deep learning dramatically outperformed previous image-recognition approaches at ImageNet\"", answer: true, verdict: "Correct.", explanation: "What made 2012 a turning point in AI history? \u2014 Deep learning dramatically outperformed previous image-recognition approaches at ImageNet" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: "\"It was where \"Artificial Intelligence\" was coined and the field formally founded\"", answer: true, verdict: "Correct.", explanation: "What is the Dartmouth Conference significant for? \u2014 It was where \"Artificial Intelligence\" was coined and the field formally founded" },
    ],
  },
  217: {
    id: 217, worldId: 201,
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: "\"A small group makes decisions that affect everyone, without broad accountability\"", answer: true, verdict: "Correct.", explanation: "Why does the concentration of AI development matter? \u2014 A small group makes decisions that affect everyone, without broad accountability" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: "\"Their values, blind spots, and data access shape how systems perform across groups\"", answer: true, verdict: "Correct.", explanation: "How can AI builders' backgrounds affect AI systems? \u2014 Their values, blind spots, and data access shape how systems perform across groups" },
  ...
  218: {
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: "\"Most public fears relate to AGI, not the narrow AI that actually exists today\"", answer: true, verdict: "Correct.", explanation: "Why does the narrow AI vs. AGI distinction matter for public debate? \u2014 Most public fears relate to AGI, not the narrow AI that actually exists today" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: "\"False\"", answer: true, verdict: "Correct.", explanation: "True or false: Superintelligent AI currently exists. \u2014 False" },
    ],
  },
}
