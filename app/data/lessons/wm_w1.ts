...
const wm_w1: Record<number, LessonData> = {
  211: {
    ...
    title: "Defining Ai",
    stops: [
      { tag: "Fact", title: "AI Software Defined", body: "Artificial intelligence is software designed to perform tasks that usually require human abilities, such as understanding language, recognizing images, making predictions, or finding patterns in large amounts of information." },
      ...
      { tag: "Big idea", title: "Rules vs. Patterns", body: "The main difference between traditional software and machine learning is how the system gets its rules. A traditional program follows instructions written by a programmer. A machine-learning system learns patterns from examples. Instead of writing a separate rule for every possible situation, developers train the system on data and allow it to improve through experience." },
      { tag: "Hot take", title: "Pattern Recognition, Not Thought", body: "That does not mean the system thinks like a person. It means it can become very good at recognizing patterns." },
      { tag: "Scenario", title: "Powerful and Fragile", body: "AI is not automatically smarter than a human. It has simply processed far more examples than a person could review in a lifetime. That makes it powerful in some areas and surprisingly fragile in others." },
    ],
    questions: [
  ...
  212: {
    ...
    stops: [
      ...
      { tag: "Example", title: "Learning Spans Many Tasks", body: "The same basic idea applies to many tasks: • Identifying spam emails • Translating languages • Recommending music • Recognizing objects in photos • Spotting patterns in medical images" },
      { tag: "Big idea", title: "Predict, Measure, Adjust", body: "The system improves by seeing examples, making predictions, measuring its mistakes, and adjusting. This process can be repeated millions or billions of times." },
      { tag: "Hot take", title: "Small Steps, Big Gains", body: "No single adjustment changes very much. The improvement comes from repetition across an enormous number of examples." },
    ],
    questions: [
  ...
  213: {
    ...
    stops: [
      ...
      { tag: "Hot take", title: "Sounding Smart Isn't Knowing", body: "The test is still debated. A machine can sound convincing without understanding what it is saying. But Turing's question helped shape the field of AI and remains relevant today." },
    ],
    questions: [
  ...
  214: {
    ...
    stops: [
      { tag: "Fact", title: "Powerful and Fragile", body: "AI is not automatically smarter than a human. It has simply processed far more examples than a person could review in a lifetime. That makes it powerful in some areas and surprisingly fragile in others." },
      { tag: "Example", title: "Where Common Sense Fails", body: "AI systems can struggle with tasks that require genuine reasoning about novel situations, common-sense knowledge, or understanding context in the way humans do — even when they perform impressively on structured, well-defined tasks." },
  ...
  216: {
    ...
    stops: [
      { tag: "Fact", title: "Where It All Started", body: "Modern AI traces back to a 1950 paper by Alan Turing. In 1956, the term \"Artificial Intelligence\" was coined at the Dartmouth Conference — widely considered the birth of AI as a formal field of research." },
      { tag: "Example", title: "Hype, Then Collapse", body: "Early decades brought enthusiasm followed by collapse. Researchers in the 1960s predicted human-level AI within 20 years. When that progress stalled, funding dried up. These periods of collapse are known as AI Winters." },
      { tag: "Big idea", title: "Expert Systems Fell Short", body: "AI came back in the 1980s with expert systems — programs that encoded human expertise as explicit rules. These too proved expensive and brittle, and interest collapsed again." },
      { tag: "Hot take", title: "The 2012 Turning Point", body: "The modern era began with two key moments: IBM's Deep Blue defeating chess champion Garry Kasparov in 1997, and the 2012 AlexNet breakthrough, when deep learning dramatically outperformed previous approaches to image recognition. The current wave — large language models, generative AI — grew from that turning point." },
    ],
    questions: [
  ...
  217: {
    ...
    stops: [
      ...
      { tag: "Example", title: "Incentives Don't Always Align", body: "Companies build AI for a range of reasons: commercial products, competitive advantage, genuine belief in its societal benefit, and the ability to replace expensive human labor. These incentives are not always aligned with the interests of users or the broader public." },
      { tag: "Big idea", title: "Who Builds Shapes Who Benefits", body: "The concentration of AI development matters. Researchers and engineers who build AI have their own values, blind spots, and access to data. A system built mostly by people from wealthy, English-speaking contexts may perform less reliably for people outside those contexts." },
      { tag: "Hot take", title: "Ask the Question", body: "This doesn't mean AI is always biased or harmful. It means asking who builds AI, why, and with what data is a reasonable and important question — not a conspiratorial one." },
    ],
    questions: [
  ...
  218: {
    ...
    title: "Types Of Ai",
    stops: [
      { tag: "Fact", title: "All AI Is Narrow", body: "Narrow AI — also called Weak AI — is designed for one specific task. This is all the AI that currently exists. Examples: facial recognition, spam filters, chess engines, voice assistants. A chess AI cannot drive a car; a language model cannot perform surgery." },
      ...
      { tag: "Big idea", title: "Superintelligence Is Theory", body: "Superintelligent AI — AI that surpasses human intelligence across all domains — exists only in theory. Some researchers consider it a plausible long-term outcome; others think it will never be achieved." },
      { tag: "Hot take", title: "Fears Outrun Reality", body: "Most public concern about AI — job displacement, dangerous autonomous decisions, existential risk — relates to general or superintelligent AI. Understanding what we actually have (narrow AI) versus what is speculative helps frame those debates more accurately." },
    ],
    questions: [
