...
const wm_w1: Record<number, LessonData> = {
  211: {
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `"True or false: All AI systems work in the same way."`, answer: false, verdict: "Correct.", explanation: "True or false: All AI systems work in the same way." },
  ...
  214: {
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `"True or false: AI systems have their own goals and motivations."`, answer: false, verdict: "Correct.", explanation: "True or false: AI systems have their own goals and motivations." },
  ...
  218: {
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `"True or false: Superintelligent AI currently exists."`, answer: false, verdict: "Correct.", explanation: "True or false: Superintelligent AI currently exists." },
    ],
  },
}
