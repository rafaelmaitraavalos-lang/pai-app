...
const wm_w1: Record<number, LessonData> = {
  211: {
    ...
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Machine learning systems learn patterns from data rather than following fixed programmed rules.`, answer: true, verdict: "Correct.", explanation: "Traditional software follows rules a programmer wrote out in advance. Machine learning is different — it figures out the patterns on its own by studying tons of examples." },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `All AI systems work in exactly the same way.`, answer: false, verdict: "Correct.", explanation: "An AI system can be very different from another. For example, a chatbot like me is super different from, say, a TikTok algorithm." },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `AI can outperform humans on some tasks because it has processed far more examples than any person could review in a lifetime.`, answer: true, verdict: "Correct.", explanation: "AI has processed far more examples than any human could in a lifetime. That is why it can feel eerily accurate." },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `A spam email filter is an example of AI.`, answer: true, verdict: "Correct.", explanation: "A spam email filter is an example of AI because it uses patterns and examples to decide what is or isn’t spam." },
    ],
  },
  212: {
    id: 212, worldId: 201,
    ...
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Machine learning is a system that learns patterns from examples rather than following fixed rules.`, answer: true, verdict: "Correct.", explanation: "AI doesn’t follow straightforward if/then rules. It learns by looking at a crazy number of examples, getting feedback on what is doing wrong, and learning from it." },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `When a machine learning system makes a wrong prediction, it adjusts slightly to reduce the error.`, answer: true, verdict: "Correct.", explanation: "Machine learning learns in exactly this way. It gets feedback on its errors and makes small adjustments in response." },
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Machine learning can only be applied to a single type of task, such as image recognition.`, answer: false, verdict: "Correct.", explanation: "Machine learning can be applied to a wide range of tasks including spam detection, music recommendation, and medical imaging." },
    ],
  },
  213: {
    id: 213, worldId: 201,
    ...
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Alan Turing's 1950 paper opened with the question "Can machines think?"`, answer: true, verdict: "Correct.", explanation: "Turing opened his famous 1950 paper with exactly that question. It was such a hard question that he ended up proposing a game to get at the answer." },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `In the Turing Test, a judge tries to determine whether they are talking to a human or a machine.`, answer: true, verdict: "Correct.", explanation: "That is the whole setup of the Turing Test: a judge chats with someone hidden and has to figure out — human or machine? If the judge can't tell, the machine passes." },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Turing shifted focus away from whether machines truly think and toward whether their behavior is indistinguishable from thinking.`, answer: true, verdict: "Correct.", explanation: "Turing realized that 'Can machines truly think?' might be impossible to answer. So he swapped in a question we can actually test: can a machine behave so convincingly that you can't tell the difference?" },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `A machine that passes the Turing Test is definitely intelligent in the same way a human is.`, answer: false, verdict: "Correct.", explanation: "Passing the Turing Test only proves a machine can act convincingly human in conversation. Acting intelligent and actually being intelligent are not the same thing — that is the test's biggest criticism." },
    ],
  },
  214: {
    id: 214, worldId: 201,
    ...
    questions: [
      ...
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `AI systems have their own goals and motivations.`, answer: false, verdict: "Correct.", explanation: "AI systems don't want anything — no goals, no motivations, no secret plans. They just carry out the objectives people give them." },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `AI can fail at tasks that require genuine reasoning or common sense outside its training data.`, answer: true, verdict: "Correct.", explanation: "Take AI outside the patterns it trained on and it can fail at things a small child finds obvious. Genuine reasoning and common sense are still human superpowers." },
    ],
  },
  215: {
    id: 215, worldId: 201,
  ...
  218: {
    ...
    questions: [
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `The only type of AI that currently exists is Narrow AI.`, answer: true, verdict: "Correct.", explanation: "Every AI in existence today is narrow — brilliant at its specific task and useless outside it. A chess AI can't drive a car; a chatbot can't fold laundry." },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `AGI is a hypothetical AI capable of performing any cognitive task a human can.`, answer: true, verdict: "Correct.", explanation: "AGI would be an AI that can handle any thinking task a human can — not just one specialty. It is still hypothetical: nobody has built one, and nobody knows when, or if, someone will." },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Most public fears about AI — like job displacement and existential risk — relate to AGI, not the narrow AI systems that actually exist today.`, answer: true, verdict: "Correct.", explanation: "When people worry about AI taking over, they are usually imagining AGI — which doesn't exist yet. Mixing that up with today's narrow AI makes it hard to have a clear debate about either one." },
      { difficulty: "Easy", tag: "Fact", stopTitle: '', question: `Superintelligent AI currently exists and is being used by governments.`, answer: false, verdict: "Correct.", explanation: "No superintelligent AI exists — not in any government, not in any secret lab. Today's AI is narrow: impressive at specific tasks, nothing like an all-powerful mind." },
    ],
  },
}
