...
const wm_w4_pt: Record<number, LessonData> = {
  341: {
    ...
    title: "O Que É Ética?",
    stops: [
      { tag: "Fact", title: "Como Devemos Agir?", body: "A ética é o ramo da filosofia que questiona como as pessoas devem agir. O que devemos uns aos outros? O que é considerado dano? Como devemos tomar decisões quando há conflito de valores? Várias estruturas éticas importantes aparecem com frequência nas discussões sobre IA." },
      { tag: "Example", title: "Julgar pelos Resultados", body: "O consequencialismo julga as ações pelos seus resultados. Uma ação é considerada boa se produzir o melhor resultado geral. A dificuldade é que os resultados podem ser difíceis de prever. As pessoas também podem discordar sobre o que é considerado o \"melhor\" resultado e quem deveria se beneficiar mais." },
      { tag: "Big idea", title: "Deveres Acima das Consequências", body: "A deontologia concentra-se em deveres e regras. Algumas ações podem ser erradas mesmo que levem a um bom resultado. A dificuldade é que as regras podem entrar em conflito. Seguir regras de forma estrita também pode levar a resultados estranhos em situações incomuns." },
      { tag: "Hot take", title: "Caráter e Seus Limites", body: "A ética das virtudes faz uma pergunta diferente: Que tipo de pessoa eu deveria ser? Ela se concentra em qualidades como honestidade, justiça, coragem e compaixão. A dificuldade é que o caráter, por si só, nem sempre diz a alguém exatamente o que fazer em uma situação nova. A ética na IA é importante porque os sistemas de IA podem afetar um grande número de pessoas. As questões éticas não estão separadas da tecnologia. Elas moldam como os sistemas devem ser construídos, testados e usados." },
    ],
    questions: [
  ...
  343: {
    ...
    stops: [
      { tag: "Fact", title: "Consentimento Exige Compreensão", body: "Muitos sistemas de IA dependem de dados coletados de pessoas que não entendiam perfeitamente como eles seriam usados. Um consentimento significativo exige mais do que clicar em \"concordo\". Uma pessoa deve entender o que está aceitando. Ela também deve ter a escolha real de dizer não." },
      { tag: "Example", title: "Recusar Não É Fácil", body: "Na prática, isso é difícil. Os acordos de termos de serviço podem ter dezenas de páginas. As políticas de privacidade podem estar escritas em jargão jurídico. Optar por não participar pode significar perder o acesso a um serviço do qual as pessoas dependem." },
      { tag: "Big idea", title: "Clicar Não É Consentir", body: "Existe uma diferença entre consentimento técnico e consentimento significativo. Consentimento técnico significa que alguém clicou em um botão. Consentimento significativo significa que a pessoa entendeu a escolha e a fez de livre e espontânea vontade. Nem sempre essas são a mesma coisa." },
      { tag: "Hot take", title: "Criadores Não Foram Consultados", body: "O problema do consentimento se estende aos criadores. Os geradores de imagens de IA e os modelos de linguagem foram treinados com enormes quantidades de conteúdo criado por humanos — muito extraído da internet sem o conhecimento, consentimento ou remuneração das pessoas que o criaram. O status legal e ético dessa prática é ativamente contestado." },
    ],
    questions: [
  ...
  345: {
    ...
    stops: [
      { tag: "Fact", title: "Explicação Deveria Ser Um Direito", body: "As pessoas muitas vezes querem que os sistemas de IA expliquem as suas decisões. Isso parece razoável. Se um sistema influencia a possibilidade de alguém receber um empréstimo, ser sinalizado como um risco ou receber uma recomendação médica, a pessoa pode querer saber o porquê." },
      { tag: "Example", title: "Redes Neurais Não Têm Regras", body: "A dificuldade é que alguns sistemas poderosos de IA são difíceis de explicar. Uma rede neural profunda nem sempre toma decisões por meio de uma lista curta de regras legíveis. Seu resultado pode emergir de muitos cálculos distribuídos por uma grande rede." },
      { tag: "Big idea", title: "Explicações Simplificadas São Imprecisas", body: "Os pesquisadores estão tentando tornar os sistemas de IA mais interpretáveis. Mas as explicações podem ser imperfeitas. Uma explicação simplificada pode não captar tudo o que está acontecendo dentro do modelo." },
  ...
  346: {
    ...
    stops: [
      ...
      { tag: "Big idea", title: "Atenção Tem Valor Comercial", body: "Uma plataforma não precisa mentir para influenciar alguém. Ela pode moldar o que a pessoa vê, quando vê e com que frequência vê. É por isso que a atenção tem valor." },
      { tag: "Hot take", title: "Autonomia Sob Pressão", body: "A autonomia — a capacidade de formar suas próprias opiniões e tomar suas próprias decisões — é gradualmente comprometida quando o ambiente de informação que você habita é moldado por sistemas que otimizam algo que não seja a sua compreensão ou bem-estar." },
    ],
    questions: [
  ...
  347: {
    ...
    stops: [
      { tag: "Fact", title: "Dizer o Que Se Quer É Difícil", body: "O problema do alinhamento faz uma pergunta simples: Como garantir que um sistema de IA faça o que as pessoas realmente querem? A dificuldade é que as pessoas nem sempre dizem exatamente o que querem dizer." },
      { tag: "Example", title: "Otimizando o Objetivo Errado", body: "Imagine mandar um sistema maximizar o número de cliques em uma plataforma. Ele pode descobrir que a raiva e a ansiedade aumentam o engajamento. Tecnicamente, ele está sendo bem-sucedido. Mas não está produzindo o resultado que as pessoas realmente desejavam." },
      { tag: "Big idea", title: "Quando Sistemas Erram o Alvo", body: "Esse problema se apresenta de muitas formas: • Um algoritmo de recomendação promove conteúdo inflamatório • Um sistema de moderação bloqueia postagens inofensivas • Uma ferramenta de correção recompensa uma escrita baseada em fórmulas • Um sistema encontra um atalho que melhora a pontuação sem resolver o problema real" },
      { tag: "Hot take", title: "Valores Resistem à Codificação", body: "Os valores humanos são complicados. Eles dependem do contexto. As pessoas discordam a respeito deles. Mesmo quando concordam, podem ter dificuldade em explicar os seus valores com precisão. O alinhamento é o desafio de traduzir objetivos humanos em instruções que um sistema possa seguir de forma confiável. Isso continua sendo um problema em aberto." },
    ],
    questions: [
  ...
  348: {
    ...
    title: "Quem Decide?",
    stops: [
      { tag: "Fact", title: "Poucos Decidem por Todos", body: "O desenvolvimento da IA está concentrado em um número relativamente pequeno de empresas, de laboratórios de pesquisa e de governos. As decisões tomadas por essas organizações podem afetar pessoas no mundo todo. Quem deveria estabelecer as regras?" },
      { tag: "Example", title: "Mercados vs. Democracia", body: "Empresas e pesquisadores: Os defensores argumentam que os especialistas e os desenvolvedores são os que melhor entendem a tecnologia e podem agir rapidamente. O risco é que um pequeno grupo de organizações privadas tome decisões que afetam todas as outras pessoas. Governos: Os defensores argumentam que instituições eleitas devem regulamentar tecnologias poderosas. O risco é que os governos ajam lentamente ou não tenham conhecimento técnico." },
      { tag: "Big idea", title: "Problemas Globais, Regras Globais", body: "Organizações internacionais: Os defensores argumentam que a IA é global e precisa de supervisão internacional. O risco é que os países discordem sobre as regras ou se recusem a cooperar. Comunidades afetadas: Os defensores argumentam que as pessoas diretamente afetadas pelos sistemas de IA deveriam ter voz sobre como esses sistemas são usados. A dificuldade é tornar essa participação significativa em vez de simbólica." },
      { tag: "Hot take", title: "Governança É Uma Escolha de Poder", body: "Não existe uma resposta perfeita. Mas deixar as grandes decisões inteiramente a cargo de um pequeno grupo de engenheiros e executivos não é uma escolha neutra. É uma escolha sobre quem detém o poder. Essa é uma das questões mais importantes na ética da IA." },
    ],
    questions: [
