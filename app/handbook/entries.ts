...
export const STARTER_ENTRIES: HandbookEntry[] = [
  {
    ...
    body: 'AI stands for Artificial Intelligence. "Artificial" because people built it. "Intelligence" because it can do things that used to need a human mind. But hold that second word loosely, because a lot of what looks like intelligence is really just very good pattern-matching.\n\nWhen you hear "AI" today, it usually means a model: a system trained on a massive pile of text, images, or other data until it can produce useful answers. It is not alive, it does not "know" things the way you do, and it is not always right.',
    doLine: 'Remember there\'s no single "the AI." Ask which one someone means.',
  },
  {
    id: 'prompting-basics',
