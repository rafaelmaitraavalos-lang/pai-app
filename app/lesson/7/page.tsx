...
const QUESTIONS: Question[] = [
  ...
  },
  {
    difficulty: 'Medium',
    tag: 'Fact',
    stopTitle: 'Why Your Answer Matters',
  ...
  },
  {
    difficulty: 'Hard',
    tag: 'Big idea',
    stopTitle: 'The End Of The Beginning',
