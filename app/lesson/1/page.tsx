...
export const STOPS: Stop[] = [
  {
    ...
    body: "More than 2,000 years before the first computer, Aristotle tried to map the rules of reasoning. If one statement was true, and another statement followed from it, could a correct conclusion be reached every time? He was not trying to build a machine. But he was asking the question behind AI: Can thought be broken into steps?",
  },
  {
    tag: "Myth bust",
    year: "1843",
  ...
  },
  {
    ...
    year: "2022\u2013now",
    title: "You're In It",
    body: "2022. ChatGPT launches and reaches 100 million users in two months \u2013 faster than any consumer app before it. AI-generated images, music, code, and video go from experimental to everywhere almost overnight. For the first time AI is something anyone can use, not just researchers. Nobody fully agrees on what it means yet. That's not a cop-out. It's actually where we are. You're not learning about something that happened. You're learning about something that's still happening.",
  },
]
