...
export default function MobileWorld1Page() {
  return (
    <div style={{ minHeight: '100%', display: 'flex', flexDirection: 'column', background: '#f5f5f5', maxWidth: 480, margin: '0 auto' }}>
      ...
      <WorldModuleView world={WORLDS[1]} basePath="/mobile" mobile />
    </div>
  )
}
