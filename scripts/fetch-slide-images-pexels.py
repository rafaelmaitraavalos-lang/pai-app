...
SLIDES = [
    ...
    (111, 1, "teamwork assembly line rows workers together"),
    (111, 2, "crowd many people working together scale"),
    (111, 3, "collaboration team celebration success high five"),
    (112, 0, "child practicing basketball sport learning improving"),
    (112, 1, "practice training repetition sports field"),
    (112, 2, "score points achievement reward progress"),
    (112, 3, "mistake learning growth mindset child"),
    (113, 0, "repetition practice skill sport getting better"),
    (113, 1, "layers stacking building blocks architecture"),
    (113, 2, "pattern recognition shapes visual learning"),
    (113, 3, "child growing learning smiling confident"),
    (114, 0, "conversation talking words communication friendly"),
    (114, 1, "completing sentence speech bubble talking"),
    (114, 2, "reading carefully attention focus text"),
    (114, 3, "language words letters communication power"),
    (115, 0, "recommendation suggestion showing options choice"),
    (115, 1, "tracking record keeping notes list"),
    (115, 2, "group friends similar interests community"),
    (115, 3, "child in control choosing decision free"),
    (116, 0, "camera eye vision seeing photo recognition"),
    (116, 1, "pixel grid mosaic digital art color"),
    (116, 2, "detective clues magnifying glass searching"),
    (116, 3, "eyes vs camera seeing understanding difference"),
    (117, 0, "mystery box inside unknown curiosity"),
    (117, 1, "black box closed sealed secret machine"),
    (117, 2, "responsibility ethics important careful"),
    (117, 3, "child asking questions curious learning"),
    (118, 0, "mistake error correction fixing learning"),
    (118, 1, "fake illusion wrong information confused"),
    (118, 2, "old outdated calendar time history"),
    (118, 3, "human checking AI guiding together"),

    # ── Elementary Lessons 121–128 — How PAI Thinks (3–5) ───────────────────
    (121, 0, "brain network connections neurons computing"),
    (121, 1, "assembly line factory rows workers systematic"),
    (121, 2, "scale large number crowd many together"),
    (121, 3, "team collaboration achievement result"),
    (122, 0, "child learning sport practice improvement progress"),
    (122, 1, "training practice drills sports outdoor"),
    (122, 2, "scoring points measurement feedback progress"),
    (122, 3, "failure learning resilience try again"),
    (123, 0, "skill practice repetition getting better athlete"),
    (123, 1, "layers architecture building construction depth"),
    (123, 2, "pattern recognition abstract visual shapes"),
    (123, 3, "student growing confidence learning success"),
    (124, 0, "conversation dialogue words typing communication"),
    (124, 1, "sentence completion words prediction language"),
    (124, 2, "careful reading attention focus detail"),
    (124, 3, "words language power communication"),
    (125, 0, "personalized recommendation feed content showing"),
    (125, 1, "data tracking analytics record keeping"),
    (125, 2, "community group same interests together"),
    (125, 3, "control choice freedom decision making"),
    (126, 0, "computer vision camera recognition image scan"),
    (126, 1, "pixel digital art grid mosaic close up"),
    (126, 2, "detective investigation clues searching evidence"),
    (126, 3, "eyes camera comparison seeing technology"),
    (127, 0, "complex system inside unknown black box"),
    (127, 1, "sealed container mysterious opaque black"),
    (127, 2, "responsibility accountability ethics careful thinking"),
    (127, 3, "child curious questioning asking why"),
    (128, 0, "error correction feedback loop improvement system"),
    (128, 1, "fake information confusion misleading data"),
    (128, 2, "outdated calendar old technology past history"),
    (128, 3, "human oversight checking guiding AI control"),
